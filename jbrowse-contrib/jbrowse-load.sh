...
# Genes
bin/flatfile-to-json.pl --out $JBROWSE_DATA --gff $AIP_HOME/$TAIR_DATA/$TAIR10_CUSTOM_GFF3/TAIR10_GFF3_genes_transposons.AIP.gff \
...
bin/flatfile-to-json.pl --out $JBROWSE_DATA --gff $AIP_HOME/$TAIR_DATA/$TAIR10_CUSTOM_GFF3/TAIR10_GFF3_genes_transposons.AIP.gff \
    --key "Protein Coding Gene Models" --nameAttributes "name,alias,id,symbol" --trackType "JBrowse/View/Track/HTMLFeatures" \
    --type "mRNA" --trackLabel "TAIR10_genes"
...
bin/flatfile-to-json.pl --out $JBROWSE_DATA --gff $AIP_HOME/$TAIR_DATA/$TAIR10_GFF3/TAIR10_unconfirmed_exons.gff \
...
bin/flatfile-to-json.pl --out $JBROWSE_DATA --gff $AIP_HOME/$TAIR_DATA/$TAIR10_GFF3/Spliced_Junctions_clustered.gff \
...
bin/flatfile-to-json.pl --out $JBROWSE_DATA \
    --gff $AIP_HOME/$TAIR_DATA/$TAIR9_CUSTOM_GFF3/Community_annotation_GFF/tair9_Quesneville_Transposons_20090429.gff \
...
bin/flatfile-to-json.pl --out $JBROWSE_DATA --gff $AIP_HOME/$TAIR_DATA/$TAIR10_GFF3/TAIR_GFF3_ssrs.gff \
...
# Assembly tracks
bin/flatfile-to-json.pl --out $JBROWSE_DATA --gff $AIP_HOME/$TAIR_DATA/$TAIR9_GFF3/Assembly_GFF/TAIR9_GFF3_assemblies.gff \
    --trackLabel "TAIR9_assemblies" --key "Tiling Path" --className "feature5" \
    --type "BAC_cloned_genomic_insert:TAIR" --nameAttributes "name"

bin/flatfile-to-json.pl --out $JBROWSE_DATA --gff $AIP_HOME/$TAIR_DATA/$TAIR9_GFF3/Assembly_GFF/tair9_Assembly_gaps.gff \
    --trackLabel "TAIR9_assembly_gaps" --key "Gaps" --className "feature5" \
    --clientConfig '{"featureCss": "background-color: red;"}' --type "gap:TAIR9"

bin/flatfile-to-json.pl --out $JBROWSE_DATA --gff $AIP_HOME/$TAIR_DATA/$TAIR9_GFF3/Assembly_GFF/tair9_assembly_updates.gff \
...
# Variation
bin/flatfile-to-json.pl --out $JBROWSE_DATA --gff $AIP_HOME/$TAIR_DATA/$TAIR9_GFF3/Variation_GFF/TAIR9_GFF3_tdnas.gff \
...
bin/flatfile-to-json.pl --out $JBROWSE_DATA --gff $AIP_HOME/$TAIR_DATA/$TAIR9_GFF3/Variation_GFF/TAIR9_GFF3_polymorphisms.gff \
...
bin/flatfile-to-json.pl --out $JBROWSE_DATA --gff $AIP_HOME/$TAIR_DATA/$TAIR9_GFF3/Variation_GFF/TAIR9_GFF3_markers.gff \
    --trackLabel "TAIR9_markers" --key "Markers" --type "marker:TAIR9" --className "generic_part_a" \
    --nameAttributes "name"

# Expression
bin/flatfile-to-json.pl --out $JBROWSE_DATA --gff $AIP_HOME/$TAIR_DATA/$TAIR9_GFF3/Expression_GFF/tair9_ATH1-121501.gff \
...
bin/flatfile-to-json.pl --out $JBROWSE_DATA \
    --gff $AIP_HOME/$TAIR_DATA/$TAIR9_CUSTOM_GFF3/Expression_GFF/tair9_atproteometair7.gff --trackLabel "TAIR9_AtProteome" \
...
bin/flatfile-to-json.pl --out $JBROWSE_DATA \
    --gff $AIP_HOME/$TAIR_DATA/$TAIR9_CUSTOM_GFF3/Expression_GFF/tair9_Briggs_atproteome7_20090401.gff \
